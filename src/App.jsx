   ...
   return (
    ...
    <nav className="flex items-center justify-between p-6">
      ...
      <div className="flex space-x-4">
        <Link to={"/singup"} className="px-4 py-2 bg-orange-600 rounded hover:bg-orange-700">Get Started</Link>
        <Link to={"/singup"} className="px-4 py-2 bg-gray-700 rounded hover:bg-gray-600">Signin</Link>
      </div>
    </nav>
    ...
    <div className="flex flex-col items-center mt-16">
      ...
      <div className="relative w-1/2">
        <input type="text" placeholder="Search" className="w-full px-4 py-2 text-black rounded" />
